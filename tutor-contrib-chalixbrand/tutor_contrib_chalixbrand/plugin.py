...
RUN npm install '@edx/brand@git+https://github.com/duremaar/brand-chalix.git'
RUN npm install '@chalix/frontend-component-header@git+https://github.com/duremaar/chalix-mfe-component-header.git#release'
RUN npm install '@chalix/frontend-component-footer@git+https://github.com/duremaar/chalix-mfe-component-footer.git#release'
"""
))
